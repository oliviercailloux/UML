...
* Présentation d’UML
* Projets - https://github.com/oliviercailloux/UML/blob/master/Projets%20-%20D%C3%A9marrage.adoc[Démarrage]
...
[[S2]]
=== S2
* Exercice noté "commit". Interdiction d’utiliser l’interface de GitHub pour vos commits. Votre `user.name` doit être égal à votre nom d’utilisateur sur GitHub (ID). Documents du cours autorisés. Vous aurez 15 minutes. Concernant : commits, branches, et shell.
