...
[[S5]]
== S5 : 9 mai
* Diagrammes de classes : simulation de véhicules. https://raw.githubusercontent.com/oliviercailloux/UML/main/Papyrus/Classes/Example%20classes%20and%20metamodel.svg[Exemple discuté], modèle https://github.com/oliviercailloux/UML-metamodel-in-Papyrus/tree/classes-car[ici]
