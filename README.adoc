...
image:https://raw.githubusercontent.com/oliviercailloux/UML/master/.github/Links%20check.svg["Links check status", link="https://github.com/oliviercailloux/UML/blob/master/.github/Last%20results.json"]
