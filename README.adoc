...
* https://www.eclipse.org/papyrus/download.html[Papyrus] (2019-06 release, 4.4.0), une implémentation open source très respectueuse de la spécification (mais d’abord difficile)
