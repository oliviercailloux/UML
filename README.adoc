...
* Papyrus : prise en main. https://github.com/oliviercailloux/UML/blob/master/Papyrus/Various.adoc#Install[Installer] Papyrus. Modéliser quelques cas d’utilisation et en tirer un diagramme de cas. (https://github.com/oliviercailloux/Simple-Papyrus-project[exemple])
