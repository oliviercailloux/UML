...
[[S2]]
=== S2
* Exercice noté "commit". Interdiction d’utiliser l’interface de GitHub pour vos commits. Votre `user.name` doit être égal à votre nom d’utilisateur sur GitHub (ID). Documents du cours autorisés. Vous aurez 15 minutes.
