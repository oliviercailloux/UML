...
=== S2
* Exercice similaire à “Starter”, comptant pour un point sur les dix points de votre future première note projet. Obligatoirement en ligne de commande. Identité doit être configurée. Documents du cours autorisés. Vous aurez 15 minutes.
