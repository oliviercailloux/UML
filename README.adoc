...
image::.github/LinksCheckFail.svg[opts="inline"]
...
image::.github/Links%20check.svg["Links check status", opts="inline", link="https://github.com/oliviercailloux/UML/blob/master/.github/Last%20results.json"]
